...
import hapi.application.indicateurs.C_AfficherEntitesHorsProcessus;
import hapi.application.indicateurs.C_ArbreDesEntitesNonRealisees;
 ...
 *
 */
public class OO_DetailParIndicateur extends JPanel implements FenetreHAPI
{
	private static final long serialVersionUID = 2659205240709503017L;
	...
	// arbre 
	private C_ArbreDesEntitesNonRealisees LS_Arbre = null;
	// liste ordonnée
	...
	C_AfficherEntitesHorsProcessus cAfficherEntitesHorsProcessus = null;

	public OO_DetailParIndicateur(ArrayList identifiants, int indicateur)
	{
		...
		cAfficherEntitesHorsProcessus = new C_AfficherEntitesHorsProcessus(idProcessus, idExecution, idEvaluation, indicateur);
	...
	public void operationMoteur()
	{
		...
		LS_Arbre = new C_ArbreDesEntitesNonRealisees(idProcessus, idExecution, idEvaluation, indicateur);
	...
	public void updateTexte()
	{
		switch (indicateur)
		{
			case 0 : /* RUA */
				...
				STV_NbNonRealises.setText(cAfficherEntitesHorsProcessus.getNombreActivitesNonRealisees() + Bundle.getText("BM_DetailCalculDesIndicateurs_NbActivitesNU"));
				break;
			case 2 : /* RUP */
				STV_NbHorsProcessus.setText(LS_HorsProcessus.getRowCount() + Bundle.getText("BM_DetailCalculDesIndicateurs_NbProduitsHP"));
				STV_NbNonRealises.setText(cAfficherEntitesHorsProcessus.getNombreProduitsNonUtilises() + Bundle.getText("BM_DetailCalculDesIndicateurs_NbProduitsNU"));
				break;
			case 3 : /* RUR */
				STV_NbHorsProcessus.setText(LS_HorsProcessus.getRowCount() + Bundle.getText("BM_DetailCalculDesIndicateurs_NbRolesHP"));
				STV_NbNonRealises.setText(cAfficherEntitesHorsProcessus.getNombreRolesNonUtilises() + Bundle.getText("BM_DetailCalculDesIndicateurs_NbRolesNU"));
				break;
		}
	}
}
