 ...
 *
 */
public class BM_RegroupementCalculIndicateurs extends JDialog implements FenetreHAPI
{
	private static final long serialVersionUID = -8415536181625940026L;
	...
	public BM_RegroupementCalculIndicateurs(Frame parent, ArrayList identifiants)
	{
	...
	public void operationSurPanel()
	{
		...
		SC_Onglets.add(new OO_RegroupementDetailParIndicateur(identifiants, 0), Bundle.getText("BM_DetailCalculDesIndicateurs_CaptionRUA"));
		SC_Onglets.add(new OO_RegroupementDetailParIndicateur(identifiants, 2), Bundle.getText("BM_DetailCalculDesIndicateurs_CaptionRUP"));
		SC_Onglets.add(new OO_RegroupementDetailParIndicateur(identifiants, 3), Bundle.getText("BM_DetailCalculDesIndicateurs_CaptionRUR"));
